...
class ExcercisesWidget extends StatefulWidget {
  const ExcercisesWidget({Key? key}) : super(key: key);

  @override
  State<ExcercisesWidget> createState() => _ExcercisesWidgetState();
}

class _ExcercisesWidgetState extends State<ExcercisesWidget> {
  List<Video>? _videos;
